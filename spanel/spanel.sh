...
certbot_update_all() {
    ${CERTBOT_PATH} renew --non-interactive --standalone --http-01-port 8008 --allow-subset-of-names --post-hook "chown -R www-data /etc/letsencrypt/live && chown -R www-data /etc/letsencrypt/archive && service nginx reload"
}
